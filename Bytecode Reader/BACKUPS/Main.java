...
public class Main {
    ...
    private static void convertToRaw() {
        ...
        for (int i = 0; i < contents.size(); i++) { 
            if (contents.get(i-1) > 32 && contents.get(i) != 127)
    ...
    private static void interpret() {
        ...
        for (int i = 0; i < numConstants-1; i++) {
            ...
            switch(tag) {
                ...
                case 5 : tagInfo = "Long";                       length = 8;  break;
                case 6 : tagInfo = "Double";                     length = 8;  break;
                ...
                default: tagInfo = "???";                        length = 0;  offsetConstant-=1; break; //Move back one if found this; must be out of bounds
            }
        ...
        //Note that this isn't perfect, as a reference to another reference won't work.
